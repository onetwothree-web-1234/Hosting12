...
def backup_db_job():
    ...
    try:
        ...
        log.info("Database backed up successfully (message_id=%s).", msg.message_id)
        return True, f"Sent as message #{msg.message_id} in the backup channel."
    except Exception as e:  # noqa: BLE001
...
def admin_panel_kb():
    ...
    kb.row(colored_button(BTN_BACKUP_NOW, style="success"), colored_button(BTN_CLOSE, style="danger"))
    return kb
...
_PANEL_BUTTON_TEXTS = {
    ...
    BTN_VERIFY_CH, BTN_BACKUP_NOW, BTN_CLOSE,
}
